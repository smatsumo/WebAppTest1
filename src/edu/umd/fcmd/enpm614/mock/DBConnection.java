...
public interface DBConnection {
	 ...
	 * 
	 * @return true if the user was successfully added to the database, false if otherwise
	 * @throws SQLException
	 */
	 ...
	 * 
	 * @param username user's username
	 * @return true if the user was successfully deleted from the database, false if otherwise
	 * @throws SQLException
	 */
